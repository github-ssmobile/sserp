...
class Audit_model extends CI_Model{
    ...
    public function get_stock_data($idcat, $idbrand, $idbranch, $idgodown){
        ...
        $brands = rtrim($brands, ',');
        $str = "Select stock.*,m.full_name from stock,model_variants m where stock.idvariant=m.id_variant and stock.idbranch = $idbranch  and stock.idproductcategory = $idcat and stock.idbrand in($brands) and stock.idgodown = $idgodown ";
//        die($str);
