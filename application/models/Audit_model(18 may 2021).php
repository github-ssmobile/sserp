...
class Audit_model extends CI_Model{
    ...
    public function get_stock_data($idcat, $idbrand, $idbranch, $idgodown){
        $str = "Select * from stock where idbranch = $idbranch  and idproductcategory = $idcat and idbrand = $idbrand and idgodown = $idgodown ";
        return $this->db->query($str)->result();
    }
    public function get_intransit_stock_data($idcat, $idbrand, $idbranch, $idgodown){
        $str = "Select * from stock where  temp_idbranch = $idbranch and idproductcategory = $idcat and idbrand = $idbrand and idgodown = $idgodown ";
        return $this->db->query($str)->result();
    }
    public function get_transfer_stock_data($idcat, $idbrand, $idbranch, $idgodown){
        $str = "Select * from stock where  transfer_from = $idbranch and idproductcategory = $idcat and idbrand = $idbrand and idgodown = $idgodown ";
        return $this->db->query($str)->result();
    }
...
//    }
    ...
    public function get_audit_start_date_from_audit_temp($idbranch,$idcat,$idbrand,$iduser, $idgodown){
        return $this->db->where('audit_temp.idbranch', $idbranch)
                        ...
                        ->where('audit_temp.idbrand', $idbrand)
