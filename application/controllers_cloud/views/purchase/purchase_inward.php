...
//        $(document).on('click', 'a[id=verify_get_customer]', function(e) { // since this is your file input
//        $.ajax({
//            url: "<?php echo base_url(); ?>Purchase/csv_verification_get_string",
//            type: "POST",
//            dataType: 'json',
//            processData: false, // important
//            contentType: false, // important
//            data: {uploadfile: $('#file').val()},
//            success: function(data) {
//                alert(data.count);
////                if(text == "success") {
...
<div class="panel panel-info panel-body" style="padding: 15px; margin: 0; overflow: auto; font-size: 13px;">
    <form>
        ...
        <div class="col-md-6">
            ...
            <div class="col-md-10"><?php echo $purchase_order->vendor_name ?>
                ...
                <input type="hidden" name="branch_lat" value="<?php echo $purchase_order->latitude ?>" />
                <input type="hidden" name="branch_long" value="<?php echo $purchase_order->longitude ?>" />
            </div>
        ...
        <div class="col-md-2">
            <select class="form-control input-sm" name="sel_idgodown" id="sel_idgodown">
            ...
            <table id="branch_data" class="table table-condensed table-hover table-bordered" style="margin-bottom: 0">
                ...
                <tr class="product_data" id="m<?php echo $product->id_variant?>">
                    ...
                    <td class="col-md-1">
                        ...
                        <select class="form-control input-sm" id="idgodown" class="idgodown" name="idgodown[]" style="width: 130px" />
    ...
    <!--                <tr class="gradient_thead">
                        <td colspan="6"></td>
                        <td>Charges
                            <input type="text" class="form-control input-sm" id="total_charges" name="total_charges" value="0" style="width: 80px" />
                        </td>
                        <td colspan="3">
