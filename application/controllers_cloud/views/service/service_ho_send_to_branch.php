...
<script>
    $(document).ready(function(){        
        $(document).on("click", ".service_stock", function(event) {          
            ...
            $.ajax({
                url:"<?php echo base_url() ?>Service/ajax_get_service_ho_send_to_branch_report",
                method:"POST",
...
<div class="col-md-10"><center><h3><span class="mdi mdi-share fa-lg"></span> Service Stock - Return from HO</h3></center></div><div class="clearfix"></div><hr>
    ...
    <div class="col-md-2 col-sm-2">
        <button class="btn btn-primary btn-sm gradient2 export" onclick="javascript:xport.toCSV('stock_data');" style="line-height: unset; display: none"><span class="fa fa-file-excel-o"></span> Export</button>
    </div>
    <div class="clearfix"></div><br>
