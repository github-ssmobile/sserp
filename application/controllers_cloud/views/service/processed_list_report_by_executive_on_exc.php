...
<script>
    $(document).ready(function(){
        ...
        $(document).on("click", ".service_stock", function(event) {
            ...
            $.ajax({
                url:"<?php echo base_url() ?>Service/ajax_get_processed_cases_by_excecutive_on_exe",
                method:"POST",
...
<div class="col-md-10"><center><h3><span class="mdi mdi-exit-to-app fa-lg"></span> Service processed List</h3></center></div><div class="clearfix"></div><hr>
