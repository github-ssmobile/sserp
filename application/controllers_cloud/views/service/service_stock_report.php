...
<div class="col-md-10"><center><h3><span class="mdi mdi-cellphone-iphone fa-lg"></span> Service Stock</h3></center></div>
 ...
 <!--<div class="col-md-1"></div>-->
    <div class="col-md-3" style="padding: 5px">
        <select class="chosen-select form-control input-sm" id="status" name="status">
            ...
            <?php foreach ($service_process_status as $process_status){ ?>
            <option value="<?php echo $process_status->id ?>"><?php echo $process_status->delivery_status ?></option>
            <?php } ?>
