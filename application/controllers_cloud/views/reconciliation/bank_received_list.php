...
<script>
    $(document).ready(function(){
        $('#filter_btn').click(function(){
            ...
            $.ajax({
                url:"<?php echo base_url() ?>Reconciliation/ajax_bank_received_list",
                method:"POST",
...
<center><h3 style="margin-top: 0"><span class="mdi mdi-clipboard-text fa-lg"></span> Payment Received Entries in Bank</h3></center><div class="clearfix"></div><hr>
...
<div class="col-md-1">
    <button class="btn btn-primary btn-sm" id="filter_btn" style="margin: 0"><span class="fa fa-file-excel-o"></span> Filter</button>
</div>
