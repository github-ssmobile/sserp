...
<center><h3 style="margin-top: 0"><span class="mdi mdi-bank fa-lg"></span> Pending Bank Reconcilation Report</h3></center><div class="clearfix"></div><hr>
...
<?php endif; ?>
<div class="thumbnail" style="height: 550px; font-size: 12px; overflow: auto; padding: 0">
