    ...
    <?php if ($one_click_receive == 0) { ?>
        ...
        <div class="thumbnail col-md-offset-2" style="padding: 0; background: #fffcf0;margin: 0 20px -1px 20px;"><br>                 
            ...
            <div class="col-md-4 col-xs-4">
                ...
                <div class="col-md-4">Shipment Date</div><div class="col-md-6"> :- <?php if ($outward->shipment_entry_time != "0000-00-00 00:00:00") {
            echo date('d-M-Y', strtotime($outward->shipment_entry_time));
