...
<script>
    $(document).ready(function(){
        ...
        $('#create_vendor').change(function(){
            if($('#brands').val() == ''){
                swal('Alert!','Select atleas one brand','warning');
                return false;
            }
        });
    });
    ...
    <form id="pay" class="">
        <div class="col-md-8 col-md-offset-2" >
            <article role="login" class="" style="padding: 15px; border-radius: 10px">
                ...
                <div class="col-md-7">
                    <input type="text" class="form-control" id="gpincode" name="gpincode" placeholder="Enter Godown Pincode" required="" />
                </div><div class="clearfix"></div><br>
                ...
                <button type="submit" formmethod="POST" id="create_vendor" formaction="<?php echo base_url('Master/save_vendor') ?>" class="pull-right btn btn-info gradient2 waves-effect">Save</button>
        ...
        <table id="vendor_data" class="table table-condensed table-full-width table-bordered table-responsive table-hover">
            ...
            <tbody class="data_1">
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-sm waves-effect" target="_blank" href="<?php echo base_url()?>Master/vendor_details_edit/<?php echo $vendor->id_vendor ?>"  style="margin: 0" >
                            <span class="mdi mdi-pen text-danger fa-lg"></span>
                        </a>
<!--                        <a class="btn btn-sm waves-effect" target="_blank" href="<?php echo base_url()?>Master/vendor_details_edit/<?php echo $vendor->id_vendor ?>" data-toggle="modal" data-target="#edit<?php echo $i ?>" style="margin: 0" >
                            <span class="mdi mdi-pen text-danger fa-lg"></span>
                        </a>
