...
<div class="col-md-10"><center><h3 style="margin: 10px 0"><span class="mdi mdi-account-network fa-lg"></span> Partner Type</h3></center></div>
...
<div id="purchase">
    <form id="pay" class="collapse">
        <div class="col-md-8 col-md-offset-2" >
            <article role="login" class="" style="padding: 15px; border-radius: 10px">
                <center><h4><span class="pe pe-7s-news-paper" style="font-size: 28px"></span> Add Partner Type</h4></center><hr>
                <label class="col-md-3 col-md-offset-1">Partner Type</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="partner" placeholder="Enter Partner Type" required="" />
                </div><div class="clearfix"></div><hr>
                <a class="btn btn-warning waves-effect gradient1" data-toggle="collapse" data-target="#pay">Cancel</a>
                <button type="submit" formmethod="POST" id="create_vendor" formaction="<?php echo base_url('Master/save_partner_type') ?>" class="pull-right btn btn-info gradient2 waves-effect">Save</button>
    ...
    <div class="thumbnail" style="overflow: auto">
        <table id="vendor_data" class="table table-condensed table-full-width table-bordered table-responsive table-hover">
            ...
            <tbody class="data_1">
                <?php $i=1; foreach ($partner_type_data as $ptype){ ?>
                <tr>
                    <td><?php echo $i++;?></td>
                    <td><?php echo $ptype->partner_type; ?></td>
                    <td>
                                ...
                                <div class="modal-content">
                                    <form>    
                                        <div class="modal-body">
                                            ...
                                            <label class="col-md-3 col-md-offset-1">Partner Type</label>
                                            <div class="col-md-7">
                                                <input type="text" class="form-control" name="partner1" value="<?php echo $ptype->partner_type; ?>" placeholder="Enter Partner Name" required="" />
                                            </div><div class="clearfix"></div><br>
                                            <a data-dismiss="modal" class="btn btn-warning waves-effect simple-tooltip">Cancel</a>
                                            <button type="submit" formmethod="POST" value="<?php echo $ptype->id_partner_type  ?>" name="id" formaction="<?php echo base_url('Master/edit_partner_type') ?>" class="pull-right btn btn-info waves-effect">Save</button>
                                            <div class="clearfix"></div>    
                                            </div>
                                        </div>
                                    </form>
