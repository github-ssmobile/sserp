            ...
            <div class="container-fluid" style="font-size: 14px; padding: 0px 15px; background-color: #fff; line-height: 23px">
                ...
                <div style="border: 1px solid #f00c0c; padding: 10px; line-height: 30px">
                    <div class="col-md-7 col-xs-7">
                        Receipt No.: &nbsp;<b><?php echo sprintf('%07d', $payment_received_data->id_payment_reconciliation) ?></b>
                    </div>
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-2">Received Type:</div>
                    ...
                    <div class="col-md-5 col-sm-5 col-xs-5" style="border-bottom: 1px dashed #f00c0c">
                        <span style="text-transform: uppercase" ><?php echo $payment_received_data->customer_fname.' '.$payment_received_data->customer_lname ?></span>
                    </div>
                    <div class="col-md-2 col-sm-2 col-xs-2">Contact No.:</div>
                    <div class="col-md-3 col-sm-3 col-xs-2" style="border-bottom: 1px dashed #f00c0c">
                        <?php echo $payment_received_data->customer_contact; ?>
                    </div><div class="clearfix"></div>
                    ...
                    <div class="col-md-10 col-sm-10 col-xs-9" style="border-bottom: 1px dashed #f00c0c">
                        <?php echo $payment_received_data->customer_address.', '.$payment_received_data->customer_city.', '.$payment_received_data->customer_state.' - '.$payment_received_data->customer_pincode; ?>
                    </div>
                    <?php if ($payment_received_data->customer_gst != '') { ?>
                    <div class="col-md-2 col-sm-2 col-xs-3">GSTIN:</div>
                    <div class="col-md-10 col-sm-10 col-xs-9" style="border-bottom: 1px dashed #f00c0c">
                        <span style="text-transform: capitalize" ><?php echo $payment_received_data->customer_gst; ?></span>
                    </div><div class="clearfix"></div>
                    <?php } ?>
                    <div class="col-md-2 col-sm-2 col-xs-3">Payment Mode:</div>
                    <div class="col-md-10 col-sm-10 col-xs-9" style="border-bottom: 1px dashed #f00c0c">
                        <?php echo $payment_received_data->payment_mode; ?> <small><?php echo $payment_received_data->payment_head; ?></small>
                        <?php if ($payment_received_data->transaction_id != '') { ?>
                        &nbsp; [<?php echo $payment_received_data->transaction_id; ?>]
                        <?php } ?>
                    </div><div class="clearfix"></div>
