...
// Quantity
    if($skuvariant == 4){
        ...
        <tr id="m<?php echo $token_product->id_stock ?>">
            <td>
            ...
            <td>
                ...
                <?php if($sale_type == 2){ ?>
                <input type="text" id="insurance_imei" name="insurance_imei[]" class="insurance_imei form-control input-sm" required="" placeholder="Enter IMEI/SRNO" />
                <?php }else{ ?>
                <input type="hidden" id="insurance_imei" name="insurance_imei[]" class="insurance_imei form-control input-sm" required="" placeholder="Enter IMEI/SRNO" />
                <?php } ?>
            </td>
