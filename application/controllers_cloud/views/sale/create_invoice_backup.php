...
.modes_block:hover .add_more_payment {
    display: block;
 }*/
</style>
...
//        }
    ...
    $(document).on('keyup', 'input[id=qty],input[id=discount_amt],input[id=price]', function() {
        ...
        $('tr').each(function () {
            ...
            $('#remaining_amount', this).html(sum_total_gross_amt.toFixed(2));
...
<!--                <select class="form-control input-sm" id="idgodown" required="">
        ...
        <div id="product" style="display: none;">
            ...
            <div class="col-md-2 col-sm-3 col-xs-5 thumbnail">
                Entered Amount: <span class="entered">0</span>
            </div>
            <div class="col-md-2 col-sm-3 col-xs-5 thumbnail">
                Remaining Amount: <div id="remaining_amount"></div>
            </div>
            <div class="col-md-4 col-sm-9 col-xs-8">
                <input type="text" class="form-control" name="remark" placeholder="Enter Remark"/>
            </div>
            <div class="col-md-2 col-sm-3 col-xs-4">
                <button type="submit" id="invoice_submit" class="btn btn-primary btn-sub gradient2" formmethod="POST" formaction="<?php echo site_url('Sale/save_sale') ?>">Submit</button>
            </div><div class="clearfix"></div>
        </div>
    </div><div class="clearfix"></div>
    </form>
