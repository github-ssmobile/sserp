...
$(document).ready(function(){
    $('#imei').change(function(){
        ...
        if(imei == ''){
            ...
            $.ajax({
                url:"<?php echo base_url() ?>Sale/ajax_track_imei",
                method:"POST",
                data:{imei : imei},
...
<div class="col-md-10"><center><h3 style="margin-top: 0"><span class="mdi mdi-margin fa-lg"></span> Track IMEI/SRNO </h3></center></div><div class="clearfix"></div><hr>
