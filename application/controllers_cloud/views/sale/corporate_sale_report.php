    ...
    $(document).ready(function (){
       $('#btnsubmit').click(function (){
           ...
           if(from != '' && to != '' && idbranch !='' && idpcat != '' && idbrand != ''){
               $.ajax({
                    url:"<?php echo base_url() ?>Sale/ajax_get_corporate_sale_report",
                    method:"POST",
...
<div class="col-md-10"><center><h3 style="margin-top: 0"><span class="mdi mdi-magnify fa-lg"></span>Corporate Sale report</h3></center></div><div class="clearfix"></div><hr><br>
<div class="col-md-2">
    <b>From</b>
...
<div class="col-md-2">
    <button type="post" class="btn btn-primary btn-sm" onclick="javascript:xport.toCSV('corporate_sale_report');"><span class="fa fa-file-excel-o"></span> Export to Excel</button>
</div>
