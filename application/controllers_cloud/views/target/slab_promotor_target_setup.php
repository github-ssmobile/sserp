    ...
    $(document).ready(function (){
        ...
        $('#btnreport').click(function (){
            ...
            if(idbranch != '' && monthyear != '' && target_slabs != ''){
               $.ajax({
                    url:"<?php echo base_url() ?>Target/ajax_get_branch_target_promotor_slab",
                    method:"POST",
...
<center><h3><span class="mdi mdi-checkbox-marked-outline fa-lg"></span> Promotor Target Setup </h3></center><hr>
