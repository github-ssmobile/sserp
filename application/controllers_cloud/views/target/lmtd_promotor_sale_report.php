    ...
    $(document).ready(function (){
        $('#btnreport').click(function (){
            ...
            if(idbranch == '' && idzone == ''){
                ...
                if(idpcat !='' && idbranch != ''){
                   $.ajax({
                        url:"<?php echo base_url() ?>Target/ajax_get_lmtd_promotor_sale_report_byidbranch",
                        method:"POST",
                ...
                if(idpcat !='' && idzone != ''){
                   $.ajax({
                        url:"<?php echo base_url() ?>Target/ajax_get_lmtd_prmotor_sale_report_byidzone",
                        method:"POST",
...
<center><h3><span class="mdi mdi-checkbox-marked-outline fa-lg"></span> LMTD Promotor Sale Report </h3></center><hr>
    ...
    <div  style="padding: 20px 10px; margin: 0">
       ...
       <div class="clearfix"></div><hr>
        ...
        <div class="col-md-2 col-sm-2 col-xs-2 pull-right ">
            <button class="btn btn-info btn-sm pull-right " onclick="javascript:xport.toCSV('LMTS_promotor_sale_report');" style="margin: 0"><span class="fa fa-file-excel-o"></span> Export To Excel</button>
        </div> 
