        ...
        $('#btnreport').click(function (){
            ...
            if(idbranch == '' && idzone == ''){
                ...
                if(from != '' && idslab !='' && idpcat !='' && idbranch != ''){
                   $.ajax({
                        url:"<?php echo base_url() ?>Target/ajax_get_drr_promotor_sale_report_slab_byidbranch",
                        method:"POST",
                ...
                if(from != '' && idslab !='' && idpcat !='' && idzone != ''){
                   $.ajax({
                        url:"<?php echo base_url() ?>Target/ajax_get_drr_promotor_sale_report_slab_byidzone",
                        method:"POST",
