    ...
    $(document).ready(function (){
        $('#btnreport').click(function (){
            ...
            if(idzone != '' && monthyear != '' && lastmonthyear != ''){
               $.ajax({
                    url:"<?php echo base_url() ?>Target/ajax_get_branch_target_data",
                    method:"POST",
...
<center><h3><span class="mdi mdi-checkbox-marked-outline fa-lg"></span> Branch Target Setup </h3></center><hr>
