...
$(document).ready(function(){
    $('#filter_btn').click(function(){
        ...
        $.ajax({
            url:"<?php echo base_url() ?>Report/ajax_cheque_reconciled_report",
            method:"POST",
...
<center><h3 style="margin-top: 0"><span class="mdi mdi-cash fa-lg"></span> Cheque Reconciled Report</h3></center><div class="clearfix"></div><hr>
