...
//          $('#sidebar').addClass("active");
        $('.btnsubmit').click(function(){
            ...
            if((idzone == '' && idbranch == '') ||(idzone != '' && idbranch != '')){
                ...
                if(idzone != ''){
                    $.ajax({
                        url:"<?php echo base_url() ?>Report/ajax_get_sale_time_analysis_byidzone",
                        method:"POST",
                ...
                if(idbranch != ''){
                    $.ajax({
                        url:"<?php echo base_url() ?>Report/ajax_get_sale_time_analysis_byidbranch",
                        method:"POST",
...
<div class="col-md-10 col-sm-10 col-xs-10"><center><h3 style="margin: 0"><span class="mdi mdi-file-document fa-lg"></span>Sale Time Analysis Report</h3></center></div><div class="clearfix"></div><br>
<div>
   ...
   <div class="clearfix"></div><br>
    ...
    <div class="col-md-1 col-sm-1 col-xs-1 pull-right"><button class="btn btn-primary btn-sm pull-right" onclick="javascript:xport.toCSV('sale_time_analysis_report');" style="margin: 0"><span class="fa fa-file-excel-o"></span> Export</button></div>
    <div class="clearfix"></div>
</div>
<div id="price_data" style="overflow-x: auto;height: 650px;padding: 0" class="thumbnail"></div>
