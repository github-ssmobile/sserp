                    ...
                    <td class="textalign">
                        <center>
                            <?php if($transfer->status==4){ ?>
                                <a target="_blank" class="thumbnail gradient2 textalign" href="<?php echo base_url('Transfer/receive_b2b_shipment/'.$transfer->id_transfer) ?>" style="margin: 0 8px;padding: 5px !important;width: 50%; color: #fff"><i class="" style="margin-right: 5px;"></i>   Receive  </a>                            
                            <?php }else { ?>
