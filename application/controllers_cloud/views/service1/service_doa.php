...
//                var serialized = $('.inv_form').serialize();
//                $.ajax({
//                    url: "<?php //  echo base_url() ?>Service/save_product_doa_return_replace",
//                    method: "POST",
//                    data: serialized,
//                    dataType: 'json',
//                    success: function (data)
        ...
        <center><h3 style="margin-top: 0"><span class="fa fa-sign-in fa-lg"></span> DOA RETURN </h3></center><br>
          <div class="clearfix"></div>
            ...
            <div class="doa_type">
                ...
                <div class="col-md-2">
                    <button type="button" class="btn  btn-primary waves-effect waves-light btn_letter" id="btn_letter" ><span class="mdi mdi-cellphone-android fa-lg"></span> DOA Letter </button>
                </div>
                <div class="col-md-2">
                    <button type="button" class="btn  btn-primary waves-effect waves-light btn_new_handset" id="btn_new_handset" ><span class="mdi mdi-cellphone-android fa-lg"></span> New Handset </button>
                </div>
                <div class="col-md-2">
                    <button type="button" class="btn  btn-primary waves-effect waves-light btn_force_doa" id="btn_force_doa" ><span class="mdi mdi-cellphone-android fa-lg"></span> Force DOA </button>
                </div>
            </div>
            <div class="clearfix"></div>    
                ...
                <input id="chk_return" type="hidden" class="chk_return" name="chk_return[]" value="<?php echo $service_data[0]->idsale ?>" />
                ...
                <?php if($service_data[0]->erp_type==0){ ?>
                    ...
                    <input type="hidden" name="gst_no" value="<?php echo $service_data[0]->customer_gst_no ?>" />  
