              ...
              <?php  if($service_stock){ ?>            
                ...
                <tbody class="data_1">
                    ...
                    <tr>                        
                        ...
                        <td>
                            <button idservice="<?php echo $stock->id_service ?>" class="btn btn-primary btn-sm gradient2 receive_service_case" ><span class="fa fa-send-o"></span> Receive and Close </button>
                        </td>
<!--                        <td>  
                            <a href="<?php // echo base_url('Service/make_doa/'.$stock->id_service) ?>" class="btn btn-primary gradient2 btn-sm" style="margin-top: 6px;line-height: unset;"><center>Received DOA</center></a>&nbsp;&nbsp;&nbsp;
