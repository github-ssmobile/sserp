...
<center><h3 style="margin-top: 0"><span class="mdi mdi-cellphone-iphone fa-lg"></span> Placement Norms Report </h3></center>
        ...
        $('.btnreport').click(function () {
            ...
            if (product_category) {
                if(branch != '' && idzone != ''){
                    ...
                    $.ajax({
                        url: "<?php echo base_url() ?>Stock/ajax_get_price_category_norms_report",
                        method: "POST",
                        data: {product_category: product_category,branch: branch,days:days, idzone: idzone, allbranch: allbranch, zones: zones},
...
<div class="thumbnail" style="padding: 0; margin: 0; min-height: 700px;">
    <div id="purchase" style="padding: 20px 10px;">
       ...
       <div class="col-md-2 col-sm-2 col-xs-2 pull-right ">
            <button class="btn btn-primary btn-sm gradient2 export" onclick="javascript:xport.toCSV('price_category_placement_norm_report');" style="margin-top: 6px;line-height: unset;"><span class="fa fa-file-excel-o"></span> Export</button>
        </div>
