...
<script>
    $(document).ready(function(){        
        $(document).on("click", ".aa_stock", function(event) {          
            ...
            $.ajax({
                url:"<?php echo base_url() ?>Stock/ajax_ageing_store_stock_analysis_report",
                method:"POST",
                data:{ idbranch:idbranch,brand: brand,  idproductcategory: product_category,idgodown:idgodown,days:days},
...
<div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2">
    <center>        
            <h3 style="margin-top: 0"><span class="mdi mdi-dropbox fa-lg"></span>Ageing Store Stock Analysis  </h3>                   
    </center>
</div>
