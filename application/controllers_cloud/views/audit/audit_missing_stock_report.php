...
<div class="thumbnail" style="padding: 0; margin: 0; min-height: 650px;">
    <div  style="padding: 20px 10px; margin: 0">
        <form>
            ...
            <input type="hidden" name="idgodown" value="5">
            <div class="col-md-1"><button class="btn btn-primary" id="btnreport" formmethod="POST" formaction="<?php echo base_url()?>Audit/get_missing_stock_for_sale">Submit</button></div>
