        ...
        <ul class="tree">
            <li>
                ...
                <ul>
                    <li>
                        ...
                        <ul>
                            <li><span class="tree_label">Branch Stock</span></li>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li>
                        <span class="tree_label">Recharge/ Insurance Sale Report</span>
                    </li>
                    <li>
                        <span class="tree_label">Recharge/ Insurance Outward Report</span>
                    </li>
                    <li>
                    ...
                    <li>
                        <span class="tree_label">Receivable Received Report</span>
                    </li>
                </ul>
            </li>
            <li>
