            ...
            <div class="container-fluid" style="font-size: 14px; padding: 0px 15px; background-color: #fff; line-height: 23px">
                ...
                <div style="border: 1px solid #f00c0c; padding: 10px; line-height: 30px">
                    <div class="col-md-7 col-xs-7">
                        Receipt No.: &nbsp;<b>CashRec/<?php echo $payment_received_data->branch_code ?>/<?php echo sprintf('%05d', $payment_received_data->id_cash_payment_receive ) ?></b>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-4" style="border-bottom: 1px dashed #f00c0c">
                        <span><?php echo $payment_received_data->inv_no ?></span>
                    </div>
                    <div class="col-md-2 col-sm-2 col-xs-2">Received by:</div>
                    <div class="col-md-4 col-sm-4 col-xs-3" style="border-bottom: 1px dashed #f00c0c">
                        <?php echo $payment_received_data->user_name; ?>
                    </div><div class="clearfix"></div>
