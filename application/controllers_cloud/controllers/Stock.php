...
<?php         
    ...
    public function ajax_sale_stock_analysis_report(){                  
            ...
            $stock_data = $this->Stock_model->get_sale_stock_analysis($idgodown,$days,$idbrand,$idproductcategory,$idcategory);
            ...
            <form>
                <table class="table table-bordered table-condensed text-center">
                    ...
                    <tr>
                        ...
                        <td><b><div class="tpqty" style="text-align: left"><?php  echo $tplac_qty; ?></div></b></td>
                    </tr>
                </table>
