            ...
            <table class="table table-bordered table-condensed text-center" id="mtd_achivement_report" >
                ...
                <tbody class="data_1">
                    ...
                    <tr style="text-align: center">
                        ...
                        <td><?php echo round($vol_ach_per,2).'%'; $total_volume_per = $total_volume_per + $vol_ach_per; ?></td>
                        ...
                        <td><?php echo round($val_ach_per,2).'%'; $total_value_per = $total_value_per + $val_ach_per; ?></td>
                        ...
                        <td><?php echo round($tar_asp_per,2).'%';  $total_asp_per = $total_asp_per + $tar_asp_per; ?></td>
                        <td><?php echo $tar_rev.'%'; $total_revenue = $total_revenue + $tar_rev; ?></td>
                    ...
                    <tr style="text-align: center">
                        ...
                        <td><b><?php  if($total_volume_target > 0){ echo round(($total_volume_ach/$total_volume_target)*100,2).'%';}else{ echo '0%'; }?></b></td>
                        <td><b><?php echo round($total_value_target,2);?></b></td>
                        <td><b><?php echo round($total_value_ach,2);?></b></td>
                        <td><b><?php if($total_value_target > 0){ echo round(($total_value_ach/$total_value_target)*100,2),'%'; } else{ echo '0%';}?></b></td>
                        <td><b><?php echo round($total_asp_target,2);?></b></td>
                        <td><b><?php $tt=0; if( $total_volume_ach > 0){$tt = $total_value_ach/$total_volume_ach; } echo round($tt,2);?></b></td>
                        <td><b><?php if($total_asp_target > 0){ echo round(($tt/$total_asp_target)*100,2).'%';}else{ echo '0%';} ?></b></td>
                        <td><b><?php echo round($total_revenue,2).'%';?></b></td>
            ...
            <table class="table table-bordered table-condensed" id="mtd_achivement_report">
                ...
                <tbody class="data_1">
                    ...
                    <tr>
                        ...
                        <td><?php echo $sale_qty; $total_volume_ach = $total_volume_ach + $sale_qty; ?></td>
                        <td><?php echo round($vol_ach_per,0).'%'; $total_volume_per = $total_volume_per + $vol_ach_per; ?></td>
                        <td><?php echo round($value_target,0); $total_value_target = $total_value_target +$value_target;  ?></td>
                        <td><?php echo $sale_total; $total_value_ach = $total_value_ach + $sale_total;  $total_landing = $total_landing + $sale_landing;?></td>
                        <td><?php echo round($val_ach_per,0).'%'; $total_value_per = $total_value_per + $val_ach_per; ?></td>
                        <td><?php echo $tar_asp; $total_asp_target = $total_asp_target + $tar_asp;  ?></td>
                        <td><?php echo round($tar_asp_achiv); $total_asp_ach = $total_asp_ach +$tar_asp_achiv;  ?></td>
                        <td><?php echo round($tar_asp_per,0).'%';  $total_asp_per = $total_asp_per + $tar_asp_per; ?></td>
                        <td><?php echo $tar_rev.'%'; $total_revenue = $total_revenue + $tar_rev; ?></td>
                        <td><?php echo round($rev_per,2).'%'; $total_revenue_ach = $total_revenue_ach + $rev_per; ?></td>
                    </tr>
                    <?php } ?>
                    <tr style="text-align: center">
                        ...
                        <td><b><?php if($total_value_target != 0){ echo round(($total_value_ach/$total_value_target)*100,2),'%'; } else{ echo '0%';}?></b></td>
                        <td><b><?php echo round($total_asp_target,0);?></b></td>
                        <td><b><?php $tt=0; if( $total_volume_ach > 0){$tt = $total_value_ach/$total_volume_ach; } echo round($tt,2);?></b></td>
                        <td><b><?php if($total_asp_target != 0){ echo round(($tt/$total_asp_target)*100,2).'%';}else{ echo '0%';} ?></b></td>
                        <td><b><?php echo round($total_revenue,2).'%';?></b></td>
                        <td><b><?php if($total_landing != 0){$t_land = (($total_value_ach - $total_landing)*100)/$total_landing;}else{$t_land=0;} echo round($t_land,2).'%';?></b></td>
...
<!--                               <td><?php foreach ($cluster_head as $clust){
                               ...
                               <td><?php echo $sale_qty; $total_volume_ach = $total_volume_ach + $sale_qty; ?></td>
                               <td><?php echo round($vol_ach_per,2).'%'; $total_volume_per = $total_volume_per + $vol_ach_per; ?></td>
                               <td><?php echo round($value_target,2); $total_value_target = $total_value_target +$value_target;  ?></td>
                               <td><?php echo round($sale_total,2); $total_value_ach = $total_value_ach + $sale_total;  $total_landing = $total_landing + $sale_landing;?></td>
                               <td><?php echo round($val_ach_per,2).'%'; $total_value_per = $total_value_per + $val_ach_per; ?></td>
                               <td><?php echo $tar_asp; $total_asp_target = $total_asp_target + $tar_asp;  ?></td>
                               <td><?php echo round($tar_asp_achiv); $total_asp_ach = $total_asp_ach +$tar_asp_achiv;  ?></td>
                               <td><?php echo round($tar_asp_per,2).'%';  $total_asp_per = $total_asp_per + $tar_asp_per; ?></td>
        ...
        if($sale_data){ ?>
                ...
                <tbody class="data_1">
                    ...
                    <tr style="text-align: center">
                        ...
                        <td><?php echo round($vol_ach,2); ?></td>
                        ...
                        <td><?php echo round($val_ach,2); ?></td>
                        <td><?php echo round($asp,2); $t_asp = $t_asp +$asp; ?></td>
                        <td><?php echo round($asp_ach,2); $t_asp_ach = $t_asp_ach + $asp_ach?></td>
                        <td><?php echo round($asp_ach_per,2); ?></td>
                    ...
                    <tr style="text-align: center">
                        ...
                        <td><b><?php echo $tval; ?></b></td>
                        <td><b><?php echo $tsa_total; ?></b></td>
                        <td><b><?php if($tval > 0){ echo round((($tsa_total/$tval)*100),2); }else{ echo '0';} ?></b></td>
                        <td><b><?php echo round($t_asp,2); ?></b></td>
                        <td><b><?php echo round($t_asp_ach,2); ?></b></td>
                        <td><b><?php if($t_asp > 0){ echo round((($t_asp_ach/$t_asp)*100),2); }else{ echo '0';}?></b></td>
                        <td><b><?php echo round($t_rev,2);?></b></td>
        ...
        if($sale_data){ ?>
                ...
                <tbody class="data_1">
                    ...
                    foreach ($sale_data as $sale){ 
                        ...
                        if($remaining_days != 0){
                            $volume_target = ($vol - $salqt)/$remaining_days;
                            $value_target = ($vall - $saletot)/$remaining_days;
                        }else{
                            $volume_target = 0;
                            $value_target = 0;
                        }
                    ...
                    <tr style="text-align: center">
                        ...
                        <td><?php echo $salqt; $tsal = $tsal + $salqt; ?></td>
                        <td><?php echo round($vol_ach,0); ?></td>
                        <td><?php echo round($value_target,0); $tval = $tval + $value_target; ?></td>
                        <td><?php echo $saletot; $tsa_total = $tsa_total + $saletot ; $t_sale_landing = $t_sale_landing + $slanding;?></td>
                        <td><?php echo round($val_ach,0); ?></td>
                        ...
                        <td><?php echo round($recvenue,0); $t_rev = $t_rev + $recvenue; ?></td>
                        <td><?php echo round($rev_per,2); ?></td>
                    </tr>
                    <?php } ?>
                    <tr style="text-align: center">
                        ...
                        <td><b><?php if($tvol != 0){ echo round((($tsal/$tvol)*100),0); }else{ echo '0';} ?></b></td>
                        <td><b><?php echo round($tval,0); ?></b></td>
                        <td><b><?php echo round($tsa_total,0); ?></b></td>
                        <td><b><?php if($tval != 0){ echo round((($tsa_total/$tval)*100),0); }else{ echo '0';} ?></b></td>
                        <td><b><?php echo round($t_asp,0); ?></b></td>
                        <td><b><?php echo round($t_asp_ach,0); ?></b></td>
                        <td><b><?php if($t_asp > 0){ echo round((($t_asp_ach/$t_asp)*100),0); }else{ echo '0';}?></b></td>
                        <td><b><?php echo round($t_rev,0);?></b></td>
                        <td><b><?php if($t_sale_landing > 0){ echo round(((($tsa_total -$t_sale_landing)*100)/$t_sale_landing),2); }else{ echo '0';}?></b></td>
                    </tr>
                </tbody>
            </table>   
            ...
            <table class="table table-bordered table-condensed text-center" id="LMTD_branch_sale_report">
                ...
                <tbody class="data_1">
                    ...
                    foreach ($sale_data as $sale){
                        ...
                        if($sale->sale_qty){ $lmtd_volume = $sale->sale_qty;}else{$lmtd_volume=0;}
                        if($sale->sale_total){$lmtd_value = $sale->sale_total;}else{ $lmtd_value =0; }
                        
                        if($sale->lsale_qty){ $mtd_volume = $sale->lsale_qty;}else{ $mtd_volume=0; }
                        if($sale->last_sale_total){ $mtd_value  = $sale->last_sale_total; } else{ $mtd_value = 0;} 
                        
                        if($sale->smart_sale_qty){$smart_volume = $sale->smart_sale_qty;}else{$smart_volume =0; }
                        if($sale->smart_total){$smart_value = $sale->smart_total;}else{$smart_value = 0;}
                        
                        if($sale->lsmart_sale_qty){ $mtd_smart_volume = $sale->lsmart_sale_qty;}else{$mtd_smart_volume =0;}
                        if($sale->lsmart_total){ $mtd_smart_value = $sale->lsmart_total;}else{ $mtd_smart_value =0 ;}
                        
                        
                        if($sale->sale_landing){$lmtd_landing = $sale->sale_landing;}else{ $lmtd_landing =0; }
                        if($sale->last_sale_landing){ $mtd_landing  = $sale->last_sale_landing; } else{ $mtd_landing = 0;} 
                    ...
                    <tr style="text-align: center">
                        ...
                        <td><?php echo round($lmtd_value,0); $t_lmtd_value =  $t_lmtd_value + $lmtd_value ?></td>
                        <td><?php echo round($mtd_value,0); $t_mtd_value = $t_mtd_value + $mtd_value; ?></td>
                    ...
                    if($tlmtd_rev > 0){ $t_rev_gap = ((($tmtd_rev - $tlmtd_rev)/$tlmtd_rev)*100); }else{ $t_rev_gap =0; }
                    ...
                    <tr style="text-align: center">
                        ...
                        <td><b><?php echo round($tlmtd_rev,0); ?></b></td>
                        <td><b><?php echo round($tmtd_rev,0); ?></b></td>
            ...
            <table class="table table-bordered table-condensed text-center" id="LMTS_promotor_sale_report">
                ...
                <tbody class="data_1">
                    ...
                    <tr style="text-align: center">
                        ...
                        <td><?php echo round($mtd_asp,0); $t_mtd_asp = $t_mtd_asp + $mtd_asp; ?></td>
                        <td><?php echo round($asp_gap,0); ?></td>
                        <td><?php echo round($lmtd_rev_per,0);$tlmtd_rev = $tlmtd_rev + $lmtd_rev_per; ?></td>
                        <td><?php echo round($mtd_rev_per,0); $tmtd_rev = $tmtd_rev + $mtd_rev_per; ?></td>
                        <td><?php echo round($rev_gap,0); ?></td>
                    </tr>
                    <?php }
                    if($t_lmtd_volume > 0){ $t_gap_volume = ((($t_mtd_volume - $t_lmtd_volume)/$t_lmtd_volume)*100); }else{ $t_gap_volume =0; }
