            ...
            <table class="table table-condensed table-striped table-bordered table-hover" style="margin-bottom: 0;">
                ...
                <tbody class="data_1">
                    ...
                    <tr>
                        ...
                        <td><?php if($stock->ho_inward_from_branch != '0000-00-00'){ echo date('d-m-Y', strtotime($stock->ho_inward_from_branch)); } ?></td>
                        <td><?php 
...
//        die('<pre>'.print_r($_POST,1).'<pre>');
        ...
        if(!$counter_faulty){
            ...
            if($warranty_status == 1){ 
                $this->Purchase_model->delete_stock_byimei($imei_no);
