...
<div style="font-family: K2D; font-size: 14px;border: 1px solid #999999">
    ...
    <div class="" style="border-radius: 0; min-height: 600px;">
        ...
        <span class="col-md-2 col-xs-2 text-muted">Supplier Invoice:</span>
        <div class="col-md-10 col-xs-10"><?php echo $inward->supplier_invoice_no ?></div><div class="clearfix"></div>
