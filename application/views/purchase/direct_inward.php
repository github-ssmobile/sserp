...
<?php if($this->session->userdata('idbranch') != NULL){ ?>
<form id="pay">
    ...
    <div class="col-md-10 col-md-offset-1 thumbnail" style="padding: 10px; margin-bottom: 40px; border-radius: 10px;">
        ...
        <div class="col-md-2">
            <div id="po_id">DI/<?php echo $y.'-'.$y2.'/'.$branch_data->branch_code; ?></div>
...
<!--            <div class="col-md-3 text-muted">Godown</div>
        ...
        <div class="col-md-5">
            ...
            <div class="col-md-9">
                ...
                <textarea rows="3" class="form-control input-sm" name="remark" placeholder="Enter Remark"></textarea>
            </div>
        </div><div class="clearfix"></div><br>
        ...
        <button type="submit" formmethod="POST" id="save_purchase_btn" formaction="<?php echo base_url('Purchase/save_purchase_direct_inward') ?>" class="pull-right btn btn-info gradient2 waves-effect">Save</button>
