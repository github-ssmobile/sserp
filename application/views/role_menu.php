    ...
    <body>
        ...
        <ul class="tree">
                ...
                <ul>
                    <li>
                        ...
                        <ul>
                            ...
                            <li><span class="tree_label">Stock Analysis Report</span></li>
                            <li><span class="tree_label">Stock Report</span></li>
                            <li><span class="tree_label">Ageing Stock Report</span></li>
                            <!--<li><span class="tree_label">Age Stock</span></li>-->
                        </ul>
                    </li>
                    <li>
                        <span class="tree_label">Stock Summary Report</span>
                    </li>
                    <li>
                        <span class="tree_label">Search Stock</span>
                    </li>
                </ul>
            </li>
            <li>
                ...
                <ul>
                    ...
                    <li>
                        <span class="tree_label">Promotor Sale Report</span>
                    </li>
                    <li>
                        <input type="checkbox" checked="checked" id="c2" />
                        <label for="c2" class="tree_label">Sale Analysis Report</label>
                        <ul>
                            <li><span class="tree_label">Achievement Product</span></li>
                        </ul>
                    </li>
                    <li>
                        <span class="tree_label">Token Sale Time Analysis</span>
                    </li>
                    <li>
                        <span class="tree_label">Token Sale Time Difference </span>
                    </li>
                    <li>
                        <span class="tree_label">Pending Sale Token Report </span>
                    </li>
                    <li>
                    ...
                    <li>
                        <span class="tree_label">Ageing Ignorance Report</span>
                    </li>
                    <li>
                        <span class="tree_label">Zone-Branch PO Report</span>
                    </li>
                    <li>
                        <span class="tree_label">Discount Limit</span>
                    </li>
                    <li>
                        <span class="tree_label">Ageing Kitti</span>
                    </li>
                    <li>
                        <span class="tree_label">MOP Credit Limit</span>
                    </li>
                </ul>
            </li>
            <li>
            ...
            <li>
                ...
                <label class="tree_label" for="c4">Graphs</label>
                <ul>
                    <li>
                        <input type="checkbox" checked="checked" id="c2" />
                        <label for="c2" class="tree_label">Category Sale Analysis</label>
                        <ul>
                            <li><span class="tree_label">Category Value Analysis</span></li>
                            <li><span class="tree_label">Category Volume Analysis</span></li>
                        </ul>
                    </li>
                </ul>
            </li>
