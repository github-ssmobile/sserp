...
<center><h3 style="margin-top: 0"><span class="mdi mdi-image-filter-tilt-shift fa-lg"></span> Zone </h3></center>    
    ...
    <div id="purchase" style="min-height: 450px; padding: 20px 10px; margin: 0">
        ...
        <div class="col-md-8 thumbnail col-md-offset-2">
            <div class="col-md-10 col-md-offset-1">  
                <center><h4><span class="pe pe-7s-news-paper" style="font-size: 28px"></span> Add Zone</h4></center><hr>
                <label class="col-md-3 col-md-offset-1">Zone Name</label>
                <div class="col-md-7">
                ...
                <button type="submit" name="id" formmethod="POST" formaction="<?php echo base_url('Master/save_zone_details') ?>" class="pull-right btn btn-info waves-effect">Save</button>
        ...
        <div class="col-md-2">
            <button class="btn btn-primary btn-sm" onclick="javascript:xport.toCSV('zone_data');"><span class="fa fa-file-excel-o"></span> Export to Excel</button>
        </div>
        ...
        <div class="clearfix"></div>
        <table id="zone_data" class="table table-condensed table-full-width table-bordered table-responsive table-hover">
            <thead>
            <th>Sr</th>
            <th>Name</th>            
            <th>Status</th>
                        ...
                        <td>
                            ...
                            <div class="modal fade" id="edit<?php echo $i ?>" style="z-index: 999999;">
                                <div class="modal-dialog">
                                    ...
                                    <?php echo form_open_multipart('Master/edit_zone') ?>    
                                        <div class="modal-body">
                                            <div class="thumbnail">
                                                <center><h4><span class="pe pe-7s-news-paper" style="font-size: 28px"></span> Edit Zone</h4></center><hr>
                                                    <label class="col-md-3 col-md-offset-1">Zone Name</label>
                                                    <div class="col-md-7">
                                                        <input type="text" class="form-control" name="zone_name" value="<?php echo $zone->zone_name ?>" required=""/>
                                                    ...
                                                    <div class="col-md-7">
                                                            <select class="form-control" name="warehouse" id="warehouse" required="">
                                                                <option value="">Select warehouse</option>
                                                                <?php foreach ($warehouse_data as $warehouse) {
                                                                    if ($warehouse->id_branch == $zone->idwarehouse) {
                                                                        ?>
                                                    ...
                                                    <div class="col-md-7">
                                                        <select class="form-control" name="status">
                                                            <option value="<?php echo $zone->active ?>"><?php if ($zone->active == 1) {
                                                                echo 'Active';
                                                            } elseif ($zone->active == 0) {
                                                                echo 'In Active';
                                                            } ?></option>
                                                            <option value="1">Active</option>
                                                            <option value="0">Inactive</option>
                                                ...
                                                <button type="submit" value="<?php echo $zone->id_zone ?>" name="id"  class="btn btn-info pull-right waves-effect"><span class=""></span> Save</button><div class="clearfix"></div>
                                            </div></div>
                                        </form>
                                    </div>
                                </div>
