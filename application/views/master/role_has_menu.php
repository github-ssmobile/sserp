                            ...
                            <?php $count=1; 
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php 
                                        $menu_sequence="";
                                        $arrayids= multi_array_search($userrole_has_menu,array('idmenu' => $mb->id_menu));
                                            if(count($arrayids)>0){
                                                $menu_sequence=$userrole_has_menu[$arrayids[0]]->menu_sequence; 
                                            }
                                        if($old_menu_id==null) { ?>
                                        <input class="form-control input-sm" type="text" name="menu_sequence[]" value="<?php echo $menu_sequence; ?>" />
                                        <?php }else if($old_menu_id==$mb->id_menu){
                                            ?>
                                        <input class="form-control input-sm" type="text" readonly="" name="menu_sequence[]" value="0" />
                                        <?php }else{ ?>
                                        <input class="form-control input-sm" type="text" name="menu_sequence[]" value="<?php echo $menu_sequence; ?>" />
                                    ...
                                    if($mb->submenu!=null) { ?>
                                    <td>
                                        <input class="form-control input-sm" type="text"  name="submenu_sequence[]" value="<?php echo $sequence; ?>" />
                                    </td>
                                    <td>
...
<!--                                    <td>
                                    ...
                                    <td>
                                        <input class="form-control input-sm" type="text"  readonly="" name="submenu_sequence[]" value="<?php echo $sequence ?>" />
                                    </td>
                                    <td>
                                        <div class="material-switch">
                                            <?php $checked="";
