...
<center><h3 style="margin-top: 0"><span class="mdi mdi-account-network fa-lg"></span> Insurence Vendor Details </h3></center><div class="clearfix"></div><hr>
...
<div>
	...
	<div class="col-md-2">
		...
		<a class="pull-right arrow-down thumbnail waves-effect simple-tooltip btn-block" href="<?php echo base_url().'vendor_create_insurence/NEW';?>"></a>
		...
		foreach ($vendor_data as $vendor) { ?>
			<tr>
				...
				<td style="text-align: center;">
					<a class="thumbnail btn-link waves-effect edit-btn" href="<?php echo base_url('vendor_create_insurence/'.$vendor['id_vendor']); ?>" style="margin: 0" >
				...
				$.ajax({
					...
					success:function(response)
					{
						if(response.status)
						{
							...
							setTimeout(function(){
								window.location.href = base_url + 'vendor_create_insurence';
							},2000);
						}else{
							alert(response.message);
						}
