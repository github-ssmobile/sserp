...
<script>
    $(document).ready(function(){        
        $(document).on("click", ".service_stock", function(event) {          
            ...
            $.ajax({
                url:"<?php echo base_url() ?>Service/ajax_get_service_branch_send_to_ho_report",
                method:"POST",
...
<div class="col-md-10"><center><h3><span class="mdi mdi-cellphone-iphone fa-lg"></span> Service Stock - Send from branch</h3></center></div><div class="clearfix"></div><hr>
