...
<script>
    $(document).ready(function(){
        ...
        $(document).on("click", ".service_stock", function(event) {          
            ...
            $.ajax({
                url:"<?php echo base_url() ?>Service/ajax_get_doa_inward_list",
                method:"POST",
...
<div class="col-md-10"><center><h3><span class="mdi mdi-cellphone-iphone fa-lg"></span> DOA Inward List</h3></center></div>
