...
<script>
    $(document).ready(function(){  
        $(document).on("click", ".service_stock", function(event) {
            ...
            $.ajax({
                url:"<?php echo base_url() ?>Service/ajax_get_assigned_cases_to_excecutive",
                method:"POST",
...
<div class="col-md-10"><center><h3><span class="mdi mdi-exit-to-app fa-lg"></span> Allocated Stock</h3></center></div><div class="clearfix"></div><hr>
