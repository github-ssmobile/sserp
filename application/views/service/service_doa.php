...
//        if(imei != ''){
            ...
            $.ajax({
                url: "<?php echo base_url() ?>Sales_return/ajax_get_imei_details",
                method: "POST",
                data:{old_idvariant:old_idvariant,imei_no:imei_no,imei : imei,idbranch: idbranch, is_dcprint: is_dcprint},
                success: function (data)
                {
                    if(data == 0){
                        ...
                        swal("Product not found in New Godown!", "Goown mismatch", "warning");
                        return false;
                    }else{
                        imeis.push(imei);
                        $('#enter_imei').val('');
...
<div style="font-family: K2D; font-size: 15px;" class="col-md-10 col-md-offset-1">    
        ...
        <center><h3 style="margin-top: 0"><span class="fa fa-sign-in fa-lg"></span> DOA RETURN </h3></center><br>
          <div class="clearfix"></div>
            ...
            <div class="col-md-12">
                <div class="col-md-4 pull-right">
                    <div class="thumbnail text-center" style="padding: 0px">
                        ...
                        <input type="hidden" id="iddgodown" name="iddgodown" value="<?php echo $service_data[0]->idgodown; ?>">                
                    </div><div class="clearfix"></div>
                </div>
            </div>
            <div class="clearfix"></div>
            ...
            <input type="hidden" name="idservice_excecutive" value="<?php echo $service_data[0]->idservice_excecutive; ?>" />            
