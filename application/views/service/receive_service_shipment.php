...
<script>
    $(document).ready(function(){        
        ...
        $(document).on("click", "#reject_shipment", function(event) {
            if(!confirm('Do you want to Reject Shipment')){
                return false;
            }
        });
...
<form style="font-size: 14px;">
    ...
    <div class="thumbnail" style="padding-top: 0px; padding-left: 0; padding-right: 0">
        ...
        <div class="col-md-8">
         ...
         <div class="clearfix"></div><br>
        <div class="col-md-2 pull-left"><button class="btn btn-danger waves-effect" id="reject_shipment" formmethod="POST" formaction="<?php echo base_url('Service/reject_servcice_at_ho_from_branch') ?>">Reject</button></div>
         <div class="col-md-2 pull-right"><button class="btn btn-primary waves-effect" id="receive_shipment" formmethod="POST" formaction="<?php echo base_url('Service/save_receive_servcice_at_ho_from_branch') ?>">Receive</button></div>
