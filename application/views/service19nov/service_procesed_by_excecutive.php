...
<script>
    $(document).ready(function(){
        ...
        $(document).on("click", ".service_stock", function(event) {
            ...
            $.ajax({
                url:"<?php echo base_url() ?>Service/ajax_get_processed_cases_by_excecutive",
                method:"POST",
...
<div class="col-md-10"><center><h3><span class="mdi mdi-exit-to-app fa-lg"></span> Service processed Stock</h3></center></div><div class="clearfix"></div><hr>
    ...
    <div class="clearfix"></div><br>
    <div class="thumbnail" style="overflow: auto;padding: 0;height: 650px;">
