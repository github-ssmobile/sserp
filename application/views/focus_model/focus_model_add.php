...
<script>
    $(document).ready(function(){
        ...
        $(document).on('change', '#model', function() {  
            ...
            var days = +$('#days').val();    
            $.ajax({
                url:"<?php echo base_url() ?>Stock/ajax_get_focus_branch_stock_by_variant",
                method:"POST",
...
<div class="col-md-8 col-md-offset-1 col-sm-8 col-sm-offset-2">
    <center>
        <h3 style="margin-top: 0"><span class="mdi mdi-dropbox fa-lg"></span> Focus Model Setup</h3>
    </center>
</div>
...
<div class="col-md-2"></div>
    ...
    <div class="thumbnail" style="overflow: auto">
        ...
        <div class="col-md-1 col-sm-2">
            <button class="btn btn-primary btn-sm gradient2 export" onclick="javascript:xport.toCSV('focus_model_data');" style="margin-top: 6px;line-height: unset; display: block"><span class="fa fa-file-excel-o"></span> Export</button>
        </div>
        <div class="clearfix"></div><br>
        <form>
            <div id="showdata" >
