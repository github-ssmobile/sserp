...
<script>
    $(document).ready(function(){        
        $('.btngenerate').click(function (){ 
            ...
            $.ajax({
                url:"<?php echo base_url() ?>Stock/ajax_focus_model_data",
                method:"POST",
...
<div class="col-md-8 col-md-offset-1 col-sm-8 col-sm-offset-2">
    <center>        
            <h3 style="margin-top: 0"><span class="mdi mdi-dropbox fa-lg"></span> Focus Model Report </h3>                   
    </center>
</div>
    ...
    <div class="thumbnail" style="overflow: auto">
       ...
       <div class="col-md-1"></div>
        <div class="col-md-1 col-sm-2">
            <button class="btn btn-primary btn-sm gradient2 export" onclick="javascript:xport.toCSV('Ageing_data');" style="margin-top: 6px;line-height: unset;display: block !important"><span class="fa fa-file-excel-o"></span> Export</button>
        </div>
