...
//    $(document).on('keyup', 'input[id=cust_mobile]', function(e) {
    $(document).on('change', 'input[id=focmodel]', function () {
        alert('hi');
...
<!--                <div class="col-md-4 p-1">
                ...
                <!--</div>-->
                <!--<div class="col-md-4 p-1">-->
                <input type="hidden" name="overall_volume" id="overall_volume" class="form-control input-sm" value="0" style="display: none" />
                <!--</div>-->
            </div>
            <div class="clearfix"></div><br>
            ...
            <div class="col-md-6">
                <div class="" style="margin-bottom: 0px;">
                    ...
                    <div class="col-md-4 p-1">
                        <label class="btn btn-block btn-sm btn-default" for="foc" style="margin-top: 0px;">
                            &nbsp; &nbsp;
                    ...
                    <div class="col-md-4 p-1">
                        <label class="btn btn-block btn-sm btn-default" for="value" style="margin-top: 0px;">
                            &nbsp; &nbsp;
                    ...
                    <div class="col-md-4 p-1">
                        <label class="btn btn-block btn-sm btn-default" for="percentage" style="margin-top: 0px;">
                            &nbsp; &nbsp;
...
<table class="table table-condensed">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?php echo empty($scheme->claim_target) ? "Qty" : "Value"; ?></td>
