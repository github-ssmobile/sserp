...
<div class="thumbnail" style="padding: 0; margin: 0; min-height: 650px;">
    <?php  if(count($audit_done_data) > 0){?>
        <center><h3>Already Done Audit For <span style="color: #3270c6"><?php echo $audit_done_data[0]->brand_name?></span> Brand. </h3></center>
    ...
    <?php } else { ?>
        <div  style="padding: 20px 10px; margin: 0" >
            <div style="font-size: 14px;">
                ...
                <div class="col-md-2" style="color: #ff0033"><b><?php echo strtoupper($brand_data->brand_name); ?></b></div>
                ...
                <div class="col-md-3">
                    <select class="form-control" name="idmodel" id="idmodel">
                        ...
                        <option value="<?php echo $qty_stock->idvariant?>"><?php echo $qty_stock->product_name; ?></option>
                        <?php } ?>
                    </select>
    <!--                <select class="form-control" name="idmodel" id="idmodel">
                        <option value="">Select Model</option>
