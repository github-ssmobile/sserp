...
//            var to = $('#to').val();
            ...
            if(idbranch == '' && idzone == ''){
                ...
                if(idslab != '' && idpcat !='' && idbranch != ''){
                   $.ajax({
                        url:"<?php echo base_url() ?>Target/ajax_get_mtd_achivement_slab_byidbranch",
                        method:"POST",
                ...
                if(idslab != '' && idpcat !='' && idzone != ''){
                   $.ajax({
                        url:"<?php echo base_url() ?>Target/ajax_get_mtd_achivement_slab_byidzone",
                        method:"POST",
...
<center><h3><span class="mdi mdi-checkbox-marked-outline fa-lg"></span> Branch MTD Achivement Report </h3></center><hr>
