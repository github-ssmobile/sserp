...
//        $('#sidebar').addClass("active");
        $('#btnreport').click(function (){
            ...
            if(idusers != '' && monthyear != ''){
               $.ajax({
                    url:"<?php echo base_url() ?>Target/ajax_get_allocator_branch_data",
                    method:"POST",
...
<center><h3><span class="mdi mdi-checkbox-marked-outline fa-lg"></span> Allocator Target Setup </h3></center><hr>
<div class="thumbnail" style="padding: 0; margin: 0; min-height: 650px;">
    <div style="padding: 20px 10px; margin: 0">
        ...
        <div class="col-md-2 col-sm-2 col-xs-2 pull-right ">
            <button class="btn btn-info btn-sm pull-right " onclick="javascript:xport.toCSV('allocator_target');" style="margin: 0"><span class="fa fa-file-excel-o"></span> Export To Excel</button>
        </div> 
