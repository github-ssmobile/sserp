    ...
    $(document).ready(function (){
        $('#btnreport').click(function (){
            ...
            if(idbranch == '' && idzone == ''){
                ...
                if(from != '' && idpcat !=''){
                   $.ajax({
                        url:"<?php echo base_url() ?>Target/ajax_get_drr_achivement_byidbranch",
                        method:"POST",
                        data:{from: from, idpcat: idpcat, idbranch: idbranch, allbranches: allbranches, allpcats: allpcats, idzone: idzone, allzone: allzone},
...
//                   $.ajax({
//                        url:"<?php echo base_url() ?>Target/ajax_get_drr_achivement_byidzone",
//                        method:"POST",
