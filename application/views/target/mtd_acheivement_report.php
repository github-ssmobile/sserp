    ...
    $(document).ready(function (){
        $('#btnreport').click(function (){
            ...
            if(idbranch == '' && idzone == ''){
                ...
                if(from != '' && to != '' && idpcat !=''){
                   $.ajax({
                        url:"<?php echo base_url() ?>Target/ajax_get_mtd_achivement_byidbranch",
                        method:"POST",
                        data:{from: from, to: to, idpcat: idpcat, idbranch: idbranch, allbranches: allbranches, allpcats: allpcats, idzone: idzone, allzone: allzone,},
...
//                   $.ajax({
//                        url:"<?php echo base_url() ?>Target/ajax_get_mtd_achivement_byidzone",
//                        method:"POST",
