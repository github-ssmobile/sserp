        ...
        <form>
            ...
            <div class='append_finance'>
                <div>
                    ...
                    <div class="col-md-2" style="padding: 5px">
                        <input type="text" name="from[]" id="from" class="form-control fromdate" data-provide="datepicker" value="<?php echo date('Y-m-d');?>" required">
                    </div>
                    <div class="col-md-2"><b>To</b></div>
                    <div class="col-md-2" style="padding: 5px">
                        <input type="text" id="to" name="to[]"  class="form-control todate" value="<?php echo date('Y-m-d');?>" data-provide="datepicker" required">
                    </div>
                    <div class="clearfix"></div>
           ...
           <div class="col-md-2"><b>Bank</b></div>
            ...
            <div class="append_swipe">
                <div>
                    <div class="col-md-2"><b>From</b></div>
                    <div class="col-md-2" style="padding: 5px">
                        <input type="text" class="form-control" data-provide="datepicker" id="from" name="from[]" required" value="<?php echo date('Y-m-d');?>">
                    </div>
                    <div class="col-md-2"><b>To</b></div>
                    <div class="col-md-2" style="padding: 5px">
                        <input type="text" class="form-control" data-provide="datepicker" id="to" name="to[]" required" value="<?php echo date('Y-m-d');?>">
                    </div>
