...
<center><h3 style="margin-top: 0"><span class="mdi mdi-cellphone-iphone fa-lg"></span> Price Report</h3></center>
...
//                        alert(data);
            ...
            $('#category,#idbrand,#product_category').change(function () {
                ...
                if (product_category) {
                    $.ajax({
                        url: "<?php echo base_url() ?>Pricing/ajax_get_model_price_bycategory/1",
                        method: "POST",
