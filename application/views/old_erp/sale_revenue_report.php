...
<script>
    $(document).ready(function (){
       $('#btnsubmit').click(function (){
           ...
           if(from != '' && to != '' && idbranch !='' ){
               $.ajax({
                    url:"<?php echo base_url() ?>Old_erp/ajax_get_sale_revenue_report",
                    method:"POST",
...
<div class="col-md-10"><center><h3 style="margin-top: 0"><span class="mdi mdi-magnify fa-lg"></span> Sale Revenue report</h3></center></div><div class="clearfix"></div><hr><br>
<div class="col-md-2">
    <b>From</b>
...
<div id="sale_data" style="overflow-x: auto;height: 720px;" >
