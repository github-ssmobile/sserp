...
// Quantity
    if($skuvariant == 4){
        ...
        $amount_diff = $token_product->mop - $token_product->online_price; ?>
        <tr id="m<?php echo $token_product->id_stock ?>" class="skuqty_row">
            ...
            <td>
                ...
                <input type="hidden" id="landing" name="landing[]" class="landing" value="<?php echo $token_product->online_price ?>" />
