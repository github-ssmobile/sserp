...
//                return false;
    ...
    $(document).on("click", "#customer_submit", function (event) {
        ...
        if ($form.find('.required').filter(function(){ return this.value === '' }).length > 0) {
            ...
            var custvalid_email = $('#email_id').val();
            var testEmail = /^[A-Z0-9._%+-]+@([A-Z0-9-]+\.)+[A-Z]{2,4}$/i;
            if(custvalid_email != ""){
            if (testEmail.test(custvalid_email))
            {
...
<!--                    <label class="col-md-3">Name<span class="red-text">*</span></label>
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control input-sm required" id="customer_contact" placeholder="Customer Contact" name="customer_contact" required=""/>
                    ...
                    <?php foreach ($customer_formdata as $data){ 
                      if($data->data_type == 'varchar'){
                          $datatype = 'text';
                          $datepicker = '';
                          if($data->filed_required == 1){
                              $req_filed = 'required';
                              $red_star = '<span class="red-text">*</span>';
                          }else{
                              $req_filed = '';
                              $red_star = '';
                          }
                    ...
                    ?>
                    <label class="col-md-3"><?php echo $data->field_name ?><?php echo $red_star ?></label>
                    <div class="col-md-9">
                        <?php if($data->field_name == "State"){ ?>
                        ...
                        <?php }else{ ?>
                            <input type="<?php echo $datatype ?>"  <?php echo $datepicker; ?> class="form-control input-sm <?php echo $req_filed ?>" placeholder="Enter <?php echo $data->field_name ?>" name="<?php echo $data->column_name ?>" id="<?php echo $data->column_name ?>"  />
                        <?php } ?>
