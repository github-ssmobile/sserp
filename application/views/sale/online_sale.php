...
//        alert(sale_type);
        if(skuvariant != ''){
            if (products.includes(skuvariant) === false){
                $.ajax({
                    url: "<?php echo base_url() ?>Sale/ajax_get_online_imei_details",
                    method: "POST",
            ...
            $.ajax({
                ...
                success: function (data)
                {
                    if(data == 0){
                        ...
                        swal("Product not found in Online Godown!", "Change godown type to Online Godown", "warning");
                        return false;
                    }else{
                        imeis.push(imei);
                        $('#enter_imei').val('');
            ...
            <div style="background-image: linear-gradient(to right top, #051937, #113c63, #176391, #168ebf, #12bceb);box-shadow: 4px 4px 15px rgba(0, 0, 0, 0.5);border-radius: 5px; margin-top: -30px">
                <div class="col-md-12 col-lg-12" style="padding: 5px">
                    <div class="" style="font-size: 17px; padding: 3px; margin: 0px; color: #fff">
                        <center><i class="fa fa-clipboard"></i> Online Invoice Form </center>
                    </div>
                </div>
...
<!--            <div><h5 style="color:#1b6caa;font-family: Kurale;">Advanced Booking Details</h5></div>-->
            ...
            <div class="col-md-2 col-sm-4" style="padding: 0 5px">
                <div style="padding: 5px 0">
                    ...
                    <input type="text" class="form-control input-sm" name="cust_lname" id="cust_lname" required="" placeholder="Customer Last Name" onfocus="blur()" value="<?php echo $bcust_lname ?>" />
                </div>
            </div>
            <div class="col-md-2 col-sm-4" style="padding: 0 5px">
                <div style="padding: 5px 0">
            ...
            <div class="col-md-2 col-sm-2" style="padding: 0 5px">
                <h5 class="text-muted" style="padding: 5px 0">Default Godown - Online
                    <input type="hidden" id="idgodown" value="6"/>
    <!--                <select class="form-control input-sm" id="idgodown" required="">
            ...
            <center id="img_scanner" style="margin-top: 10px">
                <img src="<?php echo base_url() ?>assets/images/scanner.gif" style="max-width: 100%; display: none" />
            ...
            <?php } ?>
                <div class="thumbnail" id="product" style="overflow: auto;margin-top: 10px; padding: 0">
                    <table id="inward_table" class="table table-bordered table-condensed table-hover" style="font-size: 13px; margin-bottom: 0">
                        ...
                        <?php if(isset($sale_token)){ ?>
                            <?php include_once 'online_sale_token_product.php'; ?>
                        <?php }else{ ?>
                ...
                <div class="col-md-2 col-sm-3 col-xs-4">
                    <a class="btn btn-warning gradient1" href="<?php echo base_url('Sale/online_sale'); ?>">Cancel</a>
                </div>
                ...
                <div class="col-md-2 col-sm-3 col-xs-4">
                    <button type="submit" id="invoice_submit" class="btn btn-primary btn-sub gradient2 pull-right" formmethod="POST" formaction="<?php echo site_url('Sale/save_online_sale') ?>">Submit</button>
                </div><div class="clearfix"></div>
            </div><div class="clearfix"></div>
        </div>
    </form>
    ...
    <?php }else{ 
        ...
        .'</center>';
            ...
            echo '<center><h3>Online Billing is not allowed for your branch</h3>'        
            .'<img src="'.base_url().'assets/images/highAlertIcon.gif" />'
