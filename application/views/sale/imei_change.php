...
$(document).ready(function(){
    $('#imei').change(function(){
        ...
        if(imei == ''){
            ...
            $.ajax({
                url:"<?php echo base_url() ?>Sale/ajax_track_imei_for_change",
                method:"POST",
                data:{imei : imei},
...
//            alert(newimei);
//            $.ajax({
//               url:"<?php echo base_url() ?>Sale/ajax_check_stock_duplication",
//                method:"POST",
//                data:{newimei : newimei},
//                success:function(data)
//                {
//                    alert(data);
//                    return false;
...
<div class="col-md-10"><center><h3 style="margin-top: 0"><span class="mdi mdi-margin fa-lg"></span> Change IMEI/SRNO </h3></center></div><div class="clearfix"></div><hr>
<div class="" style="background-color: #fbfbff">
    ...
    <div class="" style="font-size: 14px; min-height: 500px; overflow: auto; padding-bottom: 50px;">
