...
<div class="col-md-1" style="padding: 5px;margin-top: 8px;">Pending AT</div>
...
<!--                        <td>
                        ...
                        <td>  
                            <a href="<?php echo base_url('Service/make_doa/'.$stock->id_service) ?>" class="btn btn-primary gradient2 btn-sm btn_make_doa" style="margin-top: 6px;line-height: unset;"><center>DOA</center></a>&nbsp;&nbsp;&nbsp;
                            ...
                            <button idservice="<?php echo $stock->id_service ?>" class="btn btn-primary btn-sm gradient2 btn_receive_case" ><span class="fa fa-send-o"></span> Receive and Close </button>
                            <div class="details" style="display:none;">
                                <div class="col-md-3">Remark</div>
                                <div class="col-md-8">
                                    <input type="text" class="form-control remark" id="remark" name="remark" placeholder="Enter remark"/>
                                </div> 
                                <div class="clearfix"></div><br>
