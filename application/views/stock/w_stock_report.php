...
<div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2">
    <center>
        <h3 style="margin-top: 0"><span class="mdi mdi-dropbox fa-lg"></span> Warehouse Stock</h3>
    </center>
</div>
<div class="clearfix"></div>
 ...
 <?php  if(count($branch_data)==1){ ?>
            <input type="hidden" value="<?php echo $branch_data[0]->id_branch; ?>" name="branch" id="branch">        
    <?php  }  ?>
    ...
    <div class="col-md-2 col-sm-3" style="padding: 5px">
        ...
        <div class="col-md-2" >
            <button type="button"  class="imei_stock btn btn-primary gradient2" style="margin-top: 6px;line-height: unset;">IMEI Stock</button>
             ...
             <div class="col-md-2" >
            <button type="button"  class="intra_imei_stock btn btn-primary gradient2" style="margin-top: 6px;line-height: unset;">Intransit IMEI</button>
        </div>
