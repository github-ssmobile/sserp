        ...
        <div id="printTable" class="print_invoice"><br>
            <div class="container-fluid" style="padding: 0px 15px; border: 1px solid #999999; border-radius: 0; background-color: #fff; line-height: 23px">
                ...
                <div class="row justify-content-end" style="padding: 3px 10px;">
                    ...
                    Invoice No.: &nbsp;<b><?php echo $saledata[0]->inv_no ?></b>
                    <input type="hidden" value="<?php echo $saledata[0]->inv_no ?>" id="inv_no">
                    <input type="hidden" value="<?php echo $saledata[0]->id_sale ?>" id="inv_id">
                    <input type="hidden" value="<?php echo $saledata[0]->idbranch ?>" id="idbranch">
                    <input type="hidden" value="<?php echo $saledata[0]->customer_contact ?>" id="customer_contact">
                    <input type="hidden" value="<?php echo date('Y-m-d', strtotime($saledata[0]->invoice_date)) ?>" id="inv_date">
                    <div class="pull-right">
                        Date: &nbsp;<?php echo date('d-M-Y h:i A', strtotime($saledata[0]->invoice_date)) ?>
                    </div><div class="clearfix"></div>
                </div>
                <div class="row" style="border: 1px solid #999999;">
                    <div class="col-md-7 col-xs-7">
                        <b>Branch: &nbsp; <?php echo $branch->branch_name ?></b><br>
                        <b>Address: </b><?php echo $branch->branch_address; ?><br>
                        <b>GST No:</b> <?php echo $branch->branch_gstno; ?><br>
                        <b>Contact:</b> <?php echo $branch->branch_contact; ?><br>
                        <b>Sales Promoter:</b> <?php echo $sale->user_name; ?>
                    </div>
                    <div class="col-md-5 col-xs-5">
                        <b> Buyer,</b><br>
                        &nbsp; <span style="text-transform: uppercase" ><?php echo $saledata[0]->sale_customer_fname.' '.$saledata[0]->sale_customer_lname ?></span><br>
                          <?php if($sale_data[0]->deliver_at==0){ ?>
                                &nbsp; Address: <span style="text-transform: capitalize" ><?php echo $sale_data[0]->branch_address.', '.$sale_data[0]->branch_state_name.'-'.$sale_data[0]->branch_pincode; ?></span><br>
                        <?php }else{ ?>
                            &AElig;&nbsp; Address: <span style="text-transform: capitalize" ><?php echo $sale_data[0]->customer_address.', '.$sale_data[0]->customer_state.'-'.$sale_data[0]->customer_pincode; ?></span><br>
                        <?php } ?>
