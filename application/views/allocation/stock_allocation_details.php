            ...
            <div class="" style="padding: 0; margin: 0">
                ...
                <table id="model_data" class="table table-bordered table-condensed table-full-width table-responsive table-hover" style="font-size: 14px; margin: 0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                             <?php if($_SESSION['idrole']==15 && $data->a_status < 3){ ?>
                                <a class="thumbnail textalign delete_allo"  value="<?php echo $product->id_stock_allocation_data ?>" style="margin: 0 8px;padding: 5px !important;width: 50%;"> <?php echo $product->id_stock_allocation_data ?> </a>                      
                                 <?php }else{ 
                                        echo $product->id_stock_allocation_data ;
                                   } ?>
                            </td>
