...
//            var monthyear = $('#monthyear').val();
            $.ajax({
                type: "POST",
                url: "<?php echo base_url('Expense/ajax_get_expense_report_data'); ?>",
                data: {idbranch: idbranch, from: from, to: to, status: status},
...
<div class="col-md-10"><center><h3 style="margin: 10px 0"><span class="mdi mdi-file-chart fa-lg"></span> Expense Report </h3></center></div>
...
<div class="" style="padding: 0; margin: 0;">
    <div style="padding: 10px; margin: 0">
        ...
        <?php }else { ?>
         ...
         <?php }  ?>
        <div class="col-md-2">
            <!--<input type="text" class="form-control monthpick"  id="monthyear" name="monthyear" >-->
        ...
        <div class="col-md-1 col-md-offset-6">
            <button class="btn btn-primary btn-sm" onclick="javascript:xport.toCSV('expense_report');"><span class="fa fa-file-excel-o"></span> Export to Excel</button>
