...
<script>
    $(document).ready(function (){
        ...
        $('#btnsubmit').click(function (){
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url('Expense/ajax_get_expense_data_bybranch_month'); ?>",
                data: {idbranch: idbranch, monthyear: monthyear},
       ...
       $(document).on('click', 'a[id=approveexpense]', function() {
            ...
            var idbranch = parentdiv.find('#branchid').val();
            ...
            $.ajax({
                ...
                data: {idexpense: idexpense, approved_amount: approved_amount, remark: remark, idbranch: idbranch},
                success: function(data){
...
<div class="" style="padding: 0; margin: 0;">
    <div style="padding: 10px; margin: 0">
        ...
        <div class="col-md-1"><button class="btn btn-primary" id="btnsubmit">Submit</button></div>
        <div class="col-md-4">
                    ...
                    <tbody class="data_1">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="hidden" id="branchid" name="branchid" value="<?php echo $expense->idbranch; ?> ">
