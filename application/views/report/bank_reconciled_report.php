...
//        var modes = $('#modes').val();
        ...
        $.ajax({
            ...
            method:"POST",
            data:{idbranch: idbranch, datefrom: datefrom, dateto: dateto, branches: branches,idpayment_mode : payment_mode, idbank:idbank},
...
<div class="col-md-2">
    <select data-placeholder="Select Bank" name="idbank" id="idbank" class="chosen-select" required="" style="width: 100%">
