...
<div class="thumbnail" style="border-radius: 0; margin-bottom: 0"><br>
    <div id="sale_data" style="overflow-x: auto;height: 600px">
        ...
        <div class="col-md-4 col-xs-4">
            <div class="col-md-6">Allocation Date</div><div class="col-md-6"> - <?php echo date('d-M-Y ', strtotime($outward_data->allocation_date)) ?></div><br>
            <div class="col-md-6">Dispatch Date</div><div class="col-md-6"> - <?php echo date('d-M-Y ', strtotime($outward_data->dispatch_date)) ?></div><br>
            <div class="col-md-6">Received Date</div><div class="col-md-6"> - <?php   if($outward_data->shipment_received_date==NULL){ echo ""; }else{  echo date('d-M-Y', strtotime($outward_data->shipment_received_date)); } ?></div><br>
