    ...
    $(document).ready(function(){
        $('#datefrom, #dateto, #idbranch').change(function(){
            ...
            if(datefrom !== '' && dateto !== '' && idbranch !== ''){
                $.ajax({
                    url:"<?php echo base_url() ?>Report/ajax_cash_ledger_report",
                    method:"POST",
...
<div class="col-md-8 col-sm-8 col-xs-8 col-md-offset-1"><center><h3 style="margin: 0"><span class="mdi mdi-cash-multiple fa-lg"></span> Cash Ledger Report</h3></center></div><div class="clearfix"></div><hr>
