    ...
    $(document).ready(function (){
       $('#btnsubmit').click(function (){
          ...
          var idbranch = $('#idbranch').val();
           ...
           if(idstatus == 1){
               if(idbranch != '' && idstatus != ''){
                    $.ajax({
                     url:"<?php echo base_url() ?>Report/ajax_get_wh_to_branch_shipment_data",
                     method:"POST",
                     data:{idbranch: idbranch, idstatus: idstatus, allbranch: allbranch, from: from, to: to},
...
<div class="col-md-2">
    <button type="post" class="btn btn-primary btn-sm" onclick="javascript:xport.toCSV('warehouse_to_branch_shipment_report');"><span class="fa fa-file-excel-o"></span> Export to Excel</button>
