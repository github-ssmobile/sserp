...
//           var idbrand = $('#idbrand').val();
           if(from != '' && to != '' && idcompany !=''){
               $.ajax({
                    url:"<?php echo base_url() ?>Report/ajax_get_tally_jio_router_sale",
                    method:"POST",
...
<div class="col-md-10"><center><h3 style="margin-top: 0"><span class="fa fa-file-text-o  fa-lg"></span> Tally Jio Sale report</h3></center></div><div class="clearfix"></div><hr><br>
<div class="col-md-2">
    <b>From</b>
...
<div class="col-md-2">
    <button type="post" class="btn btn-primary btn-sm" onclick="javascript:xport.toCSV('tally_jio_sale_report');"><span class="fa fa-file-excel-o"></span> Export to Excel</button>
