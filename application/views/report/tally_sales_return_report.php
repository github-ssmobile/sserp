       ...
       $('#btnsubmit').click(function (){
          ...
          var idcompany = $('#idcompany').val();
           ...
           if(from != '' && to != '' && idcompany !='' && idpcat != '' && idbrand != ''){
               $.ajax({
                    url:"<?php echo base_url() ?>Report/ajax_get_tally_sale_return_report",
                    method:"POST",
...
<div class="col-md-10"><center><h3 style="margin-top: 0"><span class="fa fa-file-text-o  fa-lg"></span> Tally Sales Return report</h3></center></div><div class="clearfix"></div><hr><br>
<div class="col-md-2">
    <b>From</b>
...
<div class="col-md-2">
    <button type="post" class="btn btn-primary btn-sm" onclick="javascript:xport.toCSV('tally_sale_return_report');"><span class="fa fa-file-excel-o"></span> Export to Excel</button>
