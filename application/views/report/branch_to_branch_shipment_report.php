       ...
       $('#btnsubmit').click(function (){
          ...
          var idbranch = $('#idbranch').val();
           ...
           if(idbranch != '' && idstatus != '' && from !='' && to != ''){
               $.ajax({
                    url:"<?php echo base_url() ?>Report/ajax_get_b_to_b_shipment_data",
                    method:"POST",
...
<div class="col-md-2">
    <select class="form-control chosen-select" name="idstatus" id="idstatus">
        ...
        <option value="4">Intransit</option>
...
<div class="col-md-2">
    <button type="post" class="btn btn-primary btn-sm" onclick="javascript:xport.toCSV('b_to_b_shipment');"><span class="fa fa-file-excel-o"></span> Export to Excel</button>
