    ...
    $(document).ready(function(){
        $('.btnsubmit').click(function(){
            ...
            if((idzone == '' && idbranch == '') ||(idzone != '' && idbranch != '')){
                ...
                if(idzone != ''){
                    $.ajax({
                        url:"<?php echo base_url() ?>Report/ajax_get_brand_price_category_data_byzone",
                        method:"POST",
                ...
                if(idbranch != ''){
                    $.ajax({
                        url:"<?php echo base_url() ?>Report/ajax_get_brand_price_category_data_bybranch",
                        method:"POST",
...
<div class="col-md-10 col-sm-10 col-xs-10"><center><h3 style="margin: 0"><span class="mdi mdi-file-document fa-lg"></span>Brand Price Category Report</h3></center></div><div class="clearfix"></div><br>
<div>
   ...
   <div class="clearfix"></div><br>
    ...
    <div class="col-md-1 col-sm-1 col-xs-1 pull-right"><button class="btn btn-primary btn-sm pull-right" onclick="javascript:xport.toCSV('brand_price_category_report');" style="margin: 0"><span class="fa fa-file-excel-o"></span> Export</button></div>
