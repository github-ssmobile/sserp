    ...
    $(document).ready(function (){
       $('#btnsubmit').click(function (){
            ...
            if(from != '' && to != '' && idcompany !=''){
               $.ajax({
                    url:"<?php echo base_url() ?>Purchase/ajax_get_purchase_inward_data",
                    method:"POST",
...
<div class="col-md-10"><center><h3 style="margin-top: 0"><span class="fa fa-file-excel-o fa-lg"></span> Tally Purchase Report</h3></center></div><div class="clearfix"></div><hr><br>
<div class="col-md-2">
    <b>From</b>
...
<div class="col-md-2">
    <button type="post" class="btn btn-primary btn-sm" onclick="javascript:xport.toCSV('purchasereport');"><span class="fa fa-file-excel-o"></span> Export to Excel</button>
</div><div class="clearfix"></div><br>
<div id="purchase_data" style="overflow-x: auto;height: 700px">
