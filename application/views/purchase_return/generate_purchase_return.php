        ...
        $('#idvendor').change(function(){
            ...
            function(isConfirm){
                if (isConfirm){
                    ...
                    $('.vendor_block').hide();
                    $.ajax({
                        url: "<?php echo base_url() ?>Purchase_return/ajax_get_vendor_has_brands",
                        method: "POST",
...
<div class="thumbnail" style="margin: 0;overflow: auto; min-height: 800px">
    <form>
        ...
        <div id="product_box" style="display: none;">
            <div class="thumbnail" style="padding: 0">
                <table class="table table-striped table-condensed table-bordered" style="margin-bottom: 0">
                    <thead class="bg-info">
                        ...
                        <th>Godown</th>
                        <th>IMEI</th>
                        <th class="col-md-1 col-lg-1 col-xs-1">Available Qty</th>
                        <th class="col-md-1 col-lg-1 col-xs-1">Return Qty</th>
                        <th class="col-md-1 col-lg-1 col-xs-1">Remove</th>
                    </thead>
            ...
            <div class="col-md-2">
                <button formmethod="POST" formaction="<?php echo base_url('Purchase_return/save_purchase_return') ?>" class="btn btn-primary gradient2 waves-effect waves-light btn-sub">Submit</button>
            </div><div class="clearfix"></div>
        </div>
    </form>
</div>
