...
$(document).ready(function(){
    $(document).on("click", "#filter_btn", function(event) {
        ...
        jQuery.ajax({
            url: "<?php echo base_url('Reconciliation/get_insurance_purchase_recon_report') ?>",
            type: 'POST',
...
<center><h3 style="margin-top: 0"><span class="mdi mdi-lumx fa-lg"></span> Insurance Purchase Reconcilation Report</h3></center><div class="clearfix"></div><hr>
