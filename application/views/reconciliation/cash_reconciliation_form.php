...
<div class="col-md-1">
    <button class="btn btn-primary btn-sm" onclick="javascript:xport.toCSV('cash_report <?php echo date('d-m-Y h:i a') ?>');" style="margin: 0"><span class="fa fa-file-excel-o"></span> Export</button>
</div>
<div class="alert_msg"></div>
<div class="clearfix"></div><br>
<div class="thumbnail" style="height: 500px; font-size: 12px; overflow: auto; padding: 0">
    <table id="cash_report <?php echo date('d-m-Y h:i a') ?>" class="table table-condensed table-striped table-bordered table-responsive table-hover daybook" style="margin: 0"></table>
</div>
