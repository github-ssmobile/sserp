...
<!--            <div class="row justify-content-end" style="padding: 3px 10px;">
            ...
            <div class="row thumbnail" style="padding: 0">
                ...
                <div class="col-md-7 col-xs-7">DOA DC: &nbsp;DOA-<?php echo $service_data[0]->id_doa_stock_shipment ?></div>
                ...
                <div class="col-md-5 col-xs-5">
                    <b>To,</b><br>
                    Branch: &nbsp;&nbsp; <?php echo $service_data[0]->vendor_name ?>, Mob. <?php echo $service_data[0]->vendor_contact; ?><br>
                    Address: &nbsp;<?php echo $service_data[0]->vendor_address ?><br>
                    GST No.: &nbsp;<?php echo $service_data[0]->vendor_gst ?><br>
                </div>
                ...
                <table id="model_data" class="table table-bordered table-condensed table-striped" style="margin-bottom: 0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php $tmop += $service->last_purchaseprice; echo $service->last_purchaseprice ?></td>
                        <?php $cnt++; } ?>
                        <tr>
                            <td></td>
                            <td></td>
