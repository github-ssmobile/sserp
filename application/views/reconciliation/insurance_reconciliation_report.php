...
$(document).ready(function(){
    $(document).on("click", "#filter_btn", function(event) {
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            data:{idvariant : idvariant,datefrom:datefrom,dateto:dateto,idbranch:idbranch,branches: branches},
...
<div class="clearfix"></div><br>
<div class="thumbnail" style="height: 750px; overflow: auto; padding: 0">
